...
export const createAndUpdateReview = errorHandler(async (reviewInput, user) => {
...
export const canReview = errorHandler(async (roomId, userId) => {
...
export const deleteReview = errorHandler(async (reviewId, user) => {
    const isAdmin = user.role?.includes("admin");
    if (!isAdmin)
        throw new Error("Unauthorized to delete a review");
