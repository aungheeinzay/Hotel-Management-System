...
export const registerUser = errorHandler(async (input) => {
...
export const Login = errorHandler(async ({ email, password }, res) => {
...
export const uploadAvator = errorHandler(async (image, userId) => {
...
export const UpdateUserNameEmail = errorHandler(async (user, userId) => {
    const userDoc = await User.findById(userId);
    if (!userDoc)
        throw new NotFoundError("user doesn't exist");
...
export const updatePassword = errorHandler(async (oldPassword, newPassword, userId) => {
...
export const forgetPassword = errorHandler(async (customerEmail) => {
...
export const resetPasswordByToken = errorHandler(async (token, newPassword) => {
